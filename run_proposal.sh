...
CUDA_VISIBLE_DEVICES=$2 python train.py --dataset flash --exp_name flash --base_path flash_GPS_Image_LiDAR --save_path experiments/$1/ --load-cummu-model experiments/$1/flash/task2/cumu_model.pt --classes 64  --lr 0.001 --mixup --alpha 0 --smooth --smooth-eps 0.1 --config-setting 3,5,2 --arch flashnet --depth 10 --tasks 3 --learning-mode centralized --lr 0.001 --epochs 500
