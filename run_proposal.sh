...
CUDA_VISIBLE_DEVICES=$2 python train.py --dataset flash --exp_name flash --base_path flash_GPS_Image_LiDAR --save_path experiments/$1/ --load-cummu-model experiments/LIG_S1/flash/task2/cumu_model.pt --classes 64 --epochs 300  --mixup --alpha 0 --smooth --smooth-eps 0.1 --seed 1 --config-setting 3,5,2 --arch flashnet --depth 10 --tasks 3 --learning-mode federated  --batch-size 64 --lr 0.01 --momentum 0.9 --weight-decay 1e-4 --comms-round 20 --clients 0 1 2 3 4 5 6 7 8 \
